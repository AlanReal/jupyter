...
#c.ConfigurableHTTPProxy.api_url = 'http://0.0.0.0:9988'
...
c.SystemUserSpawner.host_homedir_format_string = '/code/py/noteboks'
...
#c.Spawner.notebook_dir = '~/noteboks'
...
#c.Authenticator.admin_users = set('alan')
c.Authenticator.admin_users = {'alan'}
...
#  
#  If empty, does not perform any additional restriction.
#c.Authenticator.whitelist = set('alan','bruno')
c.Authenticator.whitelist = {'alan'}
